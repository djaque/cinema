  ...
  ```
	{
		"data": [
			{
				"id": "57b37904202bba0005a61b88",
				"name": "Ramón",
				"lastname": "Cabrera"
			},
			{
				"id": "57b37929202bba0005a61b89",
				"name": "Cristina",
				"lastname": "Cruz"
			},
			{
...
* POST - http://users.local/users : Create user
  To create users you need to send a raw json in the body using this structure:+
  ```
  {"data":{"name":"dny", "lastname":"jaque"}}
  ```
  The expected respose:
  ```
  {
      "data": {
          "id": "5aac6c3621c0f8000507dd1c",
          "name": "dny",
          "lastname": "jaque"
      }
    }
...
* DELETE - http://users.local/users/{id} : Remove user by id
  For example:
  ```
  http://users.local/users/5aac6d9c21c0f8000507dd1d
  ```
  The user is deleted but the response is only a 204 response code
